...
/**
 * 
 * Se crea un mapa de dimensi�n (3,3), con los casilleros (0,0)
...
public class UserStory04Test {
	...
	//orientaci�n =derecha, este se debe crear en la
	//posici�n (0,1) del mapa, al pedirle al mapa la 
	//posici�n (0,1), me debe devolver el avatar.
