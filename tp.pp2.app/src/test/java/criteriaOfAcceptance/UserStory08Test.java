 ...
 *Adem�s se crea un Avatar en la posici�n (0,0) con orientaci�n hacia la derecha, vida=100 y 
 *un Avatar con escudo en la posici�n (3,0) con orientaci�n hacia la izquierda, vida = 100.
 *
 */
