...
public class UserStory08Test {
	...
	/**
	 ...
	 Además se crea un Avatar en la posición (0,0) con orientación hacia la derecha, vida=100 
	 y un Avatar con escudo en la posición (3,0) con orientación hacia la izquierda, vida = 100.
	 */
	@Before
