...
public class UserStory07Test {
	...
	/**Si el Avatar A recibe un da�o , quedando con vida menor igual a 0. Este muere y se muestra un mensaje con su vida 
	...
	/**Si el Avatar B recibe un da�o , quedando con vida menor igual a 0. 
	...
	/**Si el Avatar A en la posici�n (0,1) recibe un da�o, quedando con vida menor igual a 0. Este muere, quedando la posici�n (0,1) vac�a.*/
	@Test
