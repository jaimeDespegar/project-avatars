...
/**
 * 
 * Se crea un mapa de dimensi�n (3,3), con los casilleros (0,0) y (2,2) ocupados
...
public class UserStory04Test {
	...
	/**Si se crea el personaje avatar con vida = 100 y orientaci�n = derecha, este se debe crear en la posici�n (0,1) del mapa, 
	 * al pedirle al mapa la posici�n (0,1), me debe devolver el avatar.*/
	@Test
	...
	/**Si se crea el personaje avatar con escudo, este se debe crear en la posici�n (1,2), al pedirle al mapa la posici�n (1,2), m
