...
public class UserStory03Test {
	...
	/**Una linea horizontal (5,5) al (7,5), se va de rango, no es v�lido. Se lanza una excepcion de parametro invalido.*/
	...
	/**Si creo una linea horizontal (1,1) al (2,1), est� dentro del rango, es valido.*/
	@Test
	...
	/**Si creo una l�nea vertical (1,0) al (1,7), se va de rango, no es valido.*/
	@Test(expected=IllegalArgumentException.class)
